...
export type PostItem = {
  ...
  caption?: string;
  media?: LocalMedia; // If provided, we render clean media instead of Instagram oEmbed
};
...
export const posts: PostItem[] = [
  {
    ...
    media: { type: "video", src: "/media/video/1/first_v.mp4", poster: "/pics/icebakis.JPG" }
  },
  {
    ...
    media: { type: "video", src: "/media/video/2/second_v.mp4", poster: "/pics/icebakis.JPG" }
  },
  {
    ...
    media: { type: "video", src: "/media/video/3/third_v.mp4", poster: "/pics/icebakis.JPG" }
  },
  {
    ...
    media: { type: "video", src: "/media/video/4/fourth_v.mp4", poster: "/pics/icebakis.JPG" }
  },
];
